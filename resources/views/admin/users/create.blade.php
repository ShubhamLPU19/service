    ...
    <div class="card-body">
        <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }}">
                ...
                <input type="tel" maxlength="10" id="mobile" name="mobile" class="form-control" value="{{ old('mobile', isset($user) ? $user->mobile : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('work_location') ? 'has-error' : '' }}">
                ...
                <textarea type="text" id="work_location" name="work_location" class="form-control" required>{{ old('work_location', isset($user) ? $user->work_location : '') }}</textarea>
